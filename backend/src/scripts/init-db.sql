-- CodeWithMe Database Initialization Script
...
-- Create session snapshots table (for better snapshot management)
...
VALUES ('admin@codewithme.com', '$2a$10$XgXB.rLQRDRZWK1mPpU9UOJaAW4XVK6Hy5AQQm0ZJvBU8QJVoKhKO', 'Admin User', 'admin')
ON CONFLICT (email) DO NOTHING;

-- Create demo user (password: demo123)
INSERT INTO users (email, password, name, role)
VALUES ('demo@codewithme.com', '$2a$10$XHAPgXZZlLZ0UGqmARuFUeUVhGckTzJ5qRhUWrsXvN8xvDxjKcRjG', 'Demo User', 'user')
ON CONFLICT (email) DO NOTHING;